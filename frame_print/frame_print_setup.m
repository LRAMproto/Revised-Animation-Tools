function frame_print_setup(FORCE_RESET)
% frame_print_setup(FORCE_RESET);
% This function sets up necessary paths, etc. for the SVG Renderer to use.
%
...
% it detects them already on the dynamic classpath. Use frame_print_setup(1);
