...
%  18-07-2014 - Modified width/height from 100% to paper width and height, 
%               allowing support for batik SVG conversion tool.
%             - Disabled output message to allow for silent batch
%               processing.
...
% Disabled for batch processing reasons.
matversion=version;
...
fprintf(fid,'<svg preserveAspectRatio="xMinYMin meet" width="%0.3f" height="%0.3f" viewBox="0 0 %0.3f %0.3f" ',paperpos(3),paperpos(4),paperpos(3),paperpos(4));
